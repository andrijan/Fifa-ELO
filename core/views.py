    ...
    if tournament.has_groups:
        ...
        for group in groups:
            ...
            for game in group.games.all():
                ...
                d[game.home_team]['games'] = 0 if 'games' not in d[game.home_team] else d[game.home_team]['games']
                d[game.away_team]['games'] = 0 if 'games' not in d[game.away_team] else d[game.away_team]['games']
                d[game.home_team]['wins'] = 0 if 'wins' not in d[game.home_team] else d[game.home_team]['wins']
                d[game.away_team]['wins'] = 0 if 'wins' not in d[game.away_team] else d[game.away_team]['wins']
                d[game.home_team]['draws'] = 0 if 'draws' not in d[game.home_team] else d[game.home_team]['draws']
                d[game.away_team]['draws'] = 0 if 'draws' not in d[game.away_team] else d[game.away_team]['draws']
                d[game.home_team]['losses'] = 0 if 'losses' not in d[game.home_team] else d[game.home_team]['losses']
                d[game.away_team]['losses'] = 0 if 'losses' not in d[game.away_team] else d[game.away_team]['losses']
                d[game.home_team]['plus'] = 0 if 'plus' not in d[game.home_team] else d[game.home_team]['plus']
                d[game.away_team]['plus'] = 0 if 'plus' not in d[game.away_team] else d[game.away_team]['plus']
                d[game.home_team]['minus'] = 0 if 'minus' not in d[game.home_team] else d[game.home_team]['minus']
                d[game.away_team]['minus'] = 0 if 'minus' not in d[game.away_team] else d[game.away_team]['minus']
                d[game.home_team]['points'] = 0 if 'points' not in d[game.home_team] else d[game.home_team]['points']
                d[game.away_team]['points'] = 0 if 'points' not in d[game.away_team] else d[game.away_team]['points']
                if game.result:
                    ...
                    if game.winner() == game.home_team:
                        ...
                        d[game.away_team]['points'] = d[game.away_team]['points'] + 3 if 'points' in d[game.away_team] else 3
